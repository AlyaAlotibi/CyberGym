...
{
    public partial class fixed_weight : System.Web.UI.Page
    {
        CRUD cr = new CRUD();
        ...
        protected void btncalculate_Click(object sender, EventArgs e)
        {
            ...
            {
                lblDayesOfWorkout.Text = "you Should exercise 3-4 days in a week";
        ...
        public void getallWorkOut(CheckBoxList chk)
        {
            try
            {
                ...
                string mySql = @"Select * from WorkOut where ProgramId=3;";
        ...
        protected void btnExer_Click(object sender, EventArgs e)
        {
            ...
            {
                if (chkExerciese.SelectedItem == null || chkDay2.SelectedItem == null || chkDay3.SelectedItem == null )
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Please Select all 3 days at least')", true);
                }
                else if (checkProgramSubs())
                {
                    Response.Write("<script>alert('You already have program');</script>");
