<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fixed_weight.aspx.cs" Inherits="WebApplication1.fixed_weight" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
         <div class="container">
            ...
            <asp:CheckBoxList ID="chkDay5" runat="server" Visible="false">   
                            ...
                            <asp:Label runat="server" Visible="false" ID="lblEx">Want to know about the exercises?<a href="Fixed_Workout.aspx">click here</a></asp:Label>
