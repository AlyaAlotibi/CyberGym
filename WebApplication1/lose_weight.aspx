<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="lose_weight.aspx.cs" Inherits="WebApplication1.lose_weight" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:ListItem runat="server">Walking</asp:ListItem>
         ...
         <div class="form-group">
            ...
            <asp:CheckBoxList ID="chkDay6" runat="server" Visible="false">   
                            ...
                            <asp:Label runat="server" Visible="false" ID="lblEx">Want to know about the exercises?<a href="Lose_Workout.aspx">click here</a></asp:Label>
